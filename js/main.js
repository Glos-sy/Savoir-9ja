...
cat_containers.forEach((container, index)=>container.style.background = `url(https://glos-sy.github.io/Savoir-9ja/img/cat-${index + 1}.png)`);
slides.forEach((slide, index)=> slide.innerHTML = `<img src="https://glos-sy.github.io/Savoir-9ja/img/slide-${index+1}.png" alt="Auto-sliding carousel image ${index+1}"/>`);
